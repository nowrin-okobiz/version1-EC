  ...
  const handleVariantSubmit = async (values) => {
    ...
    try {
      ...
      if (error.response.data.message === "Too many files were uploaded") {
        message.error("You can use max 7 Images");
      }
      if (
        error.response.data.message ===
      ...
      <Card title="Add Product" bordered={false} className="shadow-lg p-5">
        ...
        >
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item
                label="Title (প্রত্যেক প্রোডাক্টের Title আলাদা হতে হবে)"
                name="name"
                rules={[
                  {
                    required: true,
          ...
          <div className="border p-3 rounded-md">
            ...
            {variants.map((variant, variantIndex) => (
              <div key={variantIndex} className="border-b border-[black] mb-5">
                ...
                <Form.Item
                  label="Color Code (# সহ ৬ ক্যারেকটার হতে হবে (example:#012f02))"
                ...
                <div className="mt-3 ml-10">
                  ...
                  {variant.options.map((option, optionIndex) => (
                    ...
                    >
                      ...
                      />
                      <Form.Item
                        label="SKU (প্রত্যেক প্রোডাক্টের sku আলাদা আলাদা হতে হবে)"
                      ...
                      <Form.Item
                        label="Price (ইংরেজি নাম্বারে দিবেন যেমনঃ 550)"
                      ...
                      <Form.Item
                        label="Stock (ইংরেজি নাম্বারে দিবেন যেমনঃ 10)"
          ...
          <Dragger {...variantUploadProps} onChange={handleImagePreview}>
            ...
            <p className="ant-upload-hint">
              মিনিমাম ১টি ছবি, ম্যাক্সিমাম 10টি ছবি দিতে পারবেন
            </p>
          </Dragger>
